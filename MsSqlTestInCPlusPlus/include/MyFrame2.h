	...
	private:
		    ...
		    try
		    {
                    ...
                    this->name != "" && this->mothername != "" && this->location != "" && this->birthdate != "")
                {
                    ...
                    if (matchFound == false)
                    {
                        ...
                        SQLAllocHandle(SQL_HANDLE_STMT, sqlconnectionhandle, &sqlstatementhandle);
                        // Process data.
                        SQLPrepare(sqlstatementhandle, (SQLWCHAR*)L"INSERT INTO [MsSqlTestDatabase].[dbo].[People] (Id, Name, Mothername, Location, Birthdate, IsDeleted) VALUES (?, ?, ?, ?, ?, 0)", SQL_NTS);
                    ...
                    else
                    {
                        ...
                        SQLAllocHandle(SQL_HANDLE_STMT, sqlconnectionhandle, &sqlstatementhandle);
                        // Process data.
                        SQLPrepare(sqlstatementhandle, (SQLWCHAR*)L"UPDATE [MsSqlTestDatabase].[dbo].[People] SET IsDeleted = 0 WHERE Id = ?", SQL_NTS);
		    ...
		    try
		    {
                    ...
                    this->name != "" && this->mothername != "" && this->location != "" && this->birthdate != "")
                {
                    ...
                    if (this->selectedIndex >= 0)
                    {
                        ...
                        SQLAllocHandle(SQL_HANDLE_STMT, sqlconnectionhandle, &sqlstatementhandle);
                        // Process data.
                        SQLPrepare(sqlstatementhandle, (SQLWCHAR*)L"UPDATE [MsSqlTestDatabase].[dbo].[People] SET Name = ?, Mothername = ?, Location = ?, Birthdate = ? WHERE Id = ?", SQL_NTS);
		...
		virtual void m_button4OnButtonClick( wxCommandEvent& event )
		{
		    ...
		    try
		    {
                ...
                if (this->selectedIndex >= 0)
                {
                    ...
                    SQLAllocHandle(SQL_HANDLE_STMT, sqlconnectionhandle, &sqlstatementhandle);
                    // Process data.
                    SQLPrepare(sqlstatementhandle, (SQLWCHAR*)L"UPDATE [MsSqlTestDatabase].[dbo].[People] SET IsDeleted = 1 WHERE Id = ?", SQL_NTS);
		...
		virtual void GetData()
		{
		    try
		    {
                ...
                SQLAllocHandle(SQL_HANDLE_STMT, sqlconnectionhandle, &sqlstatementhandle);
                // Process data.
                SQLExecDirect(sqlstatementhandle, (SQLWCHAR*)L"SELECT * FROM [MsSqlTestDatabase].[dbo].[People] WHERE IsDeleted = 0", SQL_NTS);
