	...
	private:
                ...
                if (/*this->name != NULL &&*/ this->name != "")
                {
                    ...
                    if (matchFound == false)
                    {
                        ...
                        if (deletedFound == false)
                        {
                            ...
                            SQLAllocHandle(SQL_HANDLE_STMT, sqlconnectionhandle, &sqlstatementhandle);
                            // Process data.
                            SQLPrepare(sqlstatementhandle, (SQLWCHAR*)L"INSERT INTO [MsSqlTestDatabase].[dbo].[Relationships] (Id, Name, IsDeleted) VALUES (?, ?, 0)", SQL_NTS);
                        ...
                        else
                        {
                            ...
                            SQLAllocHandle(SQL_HANDLE_STMT, sqlconnectionhandle, &sqlstatementhandle);
                            // Process data.
                            SQLPrepare(sqlstatementhandle, (SQLWCHAR*)L"UPDATE [MsSqlTestDatabase].[dbo].[Relationships] SET IsDeleted = 0 WHERE Id = ?", SQL_NTS);
		    ...
		    try
		    {
                ...
                if (/*this->name != NULL &&*/ this->name != "")
                {
                    ...
                    if (this->selectedIndex >= 0)
                    {
                        ...
                        SQLAllocHandle(SQL_HANDLE_STMT, sqlconnectionhandle, &sqlstatementhandle);
                        // Process data.
                        SQLPrepare(sqlstatementhandle, (SQLWCHAR*)L"UPDATE [MsSqlTestDatabase].[dbo].[Relationships] SET Name = ? WHERE Id = ?", SQL_NTS);
		...
		virtual void m_button4OnButtonClick( wxCommandEvent& event )
		{
		    ...
		    try
		    {
                ...
                if (this->selectedIndex >= 0)
                {
                    ...
                    SQLAllocHandle(SQL_HANDLE_STMT, sqlconnectionhandle, &sqlstatementhandle);
                    // Process data.
                    SQLPrepare(sqlstatementhandle, (SQLWCHAR*)L"UPDATE [MsSqlTestDatabase].[dbo].[Relationships] SET IsDeleted = 1 WHERE Id = ?", SQL_NTS);
		...
		virtual void GetData()
		{
		    try
		    {
                ...
                SQLAllocHandle(SQL_HANDLE_STMT, sqlconnectionhandle, &sqlstatementhandle);
                // Process data.
                SQLExecDirect(sqlstatementhandle, (SQLWCHAR*)L"SELECT * FROM [MsSqlTestDatabase].[dbo].[Relationships] WHERE IsDeleted = 0", SQL_NTS);
