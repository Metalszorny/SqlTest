	...
	private:
		...
		virtual void m_grid1OnGridSelectCell( wxGridEvent& event )
		{
		    ...
		    if (event.GetRow() >= 0)
            {
                try
                {
                    ...
                    // Connect to the DSN.
                    SQLDriverConnect(sqlconnectionhandle, NULL, (SQLWCHAR*)L"DSN=MsSqlTestDatabase;SERVER=localhost;UID=root;PWD=RootUser0123456789;DRIVER=SQL Server;", SQL_NTS, retconstring, 1024, NULL, SQL_DRIVER_NOPROMPT);
                    ...
                    // Process data.
                    SQLPrepare(sqlstatementhandle, (SQLWCHAR*)L"SELECT * FROM [MsSqlTestDatabase].[dbo].[Relations] WHERE Id = ?", SQL_NTS);
		...
		virtual void m_comboBox1OnCombobox( wxCommandEvent& event )
		{
		    try
		    {
                ...
                SQLAllocHandle(SQL_HANDLE_STMT, sqlconnectionhandle, &sqlstatementhandle);
                // Process data.
                SQLPrepare(sqlstatementhandle, (SQLWCHAR*)L"SELECT * FROM [MsSqlTestDatabase].[dbo].[People] WHERE Id = ?", SQL_NTS);
		...
		virtual void m_comboBox2OnCombobox( wxCommandEvent& event )
		{
		    try
		    {
                ...
                SQLAllocHandle(SQL_HANDLE_STMT, sqlconnectionhandle, &sqlstatementhandle);
                // Process data.
                SQLPrepare(sqlstatementhandle, (SQLWCHAR*)L"SELECT * FROM [MsSqlTestDatabase].[dbo].[Relationships] WHERE Id = ?", SQL_NTS);
		...
		virtual void m_button2OnButtonClick( wxCommandEvent& event )
		{
		    ...
		    try
		    {
                    ...
                    this->name1 > 0 && this->relationship > 0 && this->name2 > 0 && this->name1 != this->name2)
                {
                    ...
                    SQLAllocHandle(SQL_HANDLE_STMT, sqlconnectionhandle, &sqlstatementhandle);
                    // Process data.
                    SQLExecDirect(sqlstatementhandle, (SQLWCHAR*)L"SELECT * FROM [MsSqlTestDatabase].[dbo].[Relations]", SQL_NTS);
                    ...
                    if (matchFound == false)
                    {
                        ...
                        SQLAllocHandle(SQL_HANDLE_STMT, sqlconnectionhandle, &sqlstatementhandle);
                        // Process data.
                        SQLPrepare(sqlstatementhandle, (SQLWCHAR*)L"INSERT INTO [MsSqlTestDatabase].[dbo].[Relations] (Id, Person1, Relationship, Person2, IsDeleted) VALUES (?, ?, ?, ?, 0)", SQL_NTS);
                    ...
                    else
                    {
                        ...
                        SQLAllocHandle(SQL_HANDLE_STMT, sqlconnectionhandle, &sqlstatementhandle);
                        // Process data.
                        SQLPrepare(sqlstatementhandle, (SQLWCHAR*)L"UPDATE [MsSqlTestDatabase].[dbo].[Relations] SET IsDeleted = 0 WHERE Id = ?", SQL_NTS);
		    ...
		    try
		    {
                    ...
                    this->name1 > 0 && this->relationship > 0 && this->name2 > 0 && this->name1 != this->name2)
                {
                    ...
                    if (this->selectedIndex >= 0)
                    {
                        ...
                        SQLAllocHandle(SQL_HANDLE_STMT, sqlconnectionhandle, &sqlstatementhandle);
                        // Process data.
                        SQLPrepare(sqlstatementhandle, (SQLWCHAR*)L"UPDATE [MsSqlTestDatabase].[dbo].[Relations] SET Person1 = ?, Relationship = ?, Person2 = ? WHERE Id = ?", SQL_NTS);
		...
		virtual void m_button4OnButtonClick( wxCommandEvent& event )
		{
		    ...
		    try
		    {
                ...
                if (this->selectedIndex >= 0)
                {
                    ...
                    SQLAllocHandle(SQL_HANDLE_STMT, sqlconnectionhandle, &sqlstatementhandle);
                    // Process data.
                    SQLPrepare(sqlstatementhandle, (SQLWCHAR*)L"UPDATE [MsSqlTestDatabase].[dbo].[Relations] SET IsDeleted = 1 WHERE Id = ?", SQL_NTS);
		...
		virtual void GetData()
		{
		    try
		    {
                ...
                SQLAllocHandle(SQL_HANDLE_STMT, sqlconnectionhandle, &sqlstatementhandle);
                // Process data.
                SQLExecDirect(sqlstatementhandle, (SQLWCHAR*)L"SELECT * FROM [MsSqlTestDatabase].[dbo].[People]", SQL_NTS);
                ...
                SQLAllocHandle(SQL_HANDLE_STMT, sqlconnectionhandle, &sqlstatementhandle);
                // Process data.
                SQLExecDirect(sqlstatementhandle, (SQLWCHAR*)L"SELECT * FROM [MsSqlTestDatabase].[dbo].[Relationships]", SQL_NTS);
                ...
                SQLAllocHandle(SQL_HANDLE_STMT, sqlconnectionhandle, &sqlstatementhandle);
                // Process data.
                SQLExecDirect(sqlstatementhandle, (SQLWCHAR*)L"SELECT * FROM [MsSqlTestDatabase].[dbo].[Relations] WHERE IsDeleted = 0", SQL_NTS);
