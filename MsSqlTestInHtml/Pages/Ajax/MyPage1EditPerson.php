<?
        ...
        $_POST["location"] != "" && $_POST["birthdate"] != "")
    {
        ...
        if (isset($_POST["id"]) && is_numeric($_POST["id"]) && $_POST["id"] > 0)
        {
            ...
            $query = odbc_exec($connection, "UPDATE [MsSqlTestDatabase].[dbo].[People] SET Name = '$nameValue', Mothername = '$mothernameValue', Location = '$locationValue', Birthdate = '$birthdateValue' WHERE Id = '$idValue'");
        }
    }
?>