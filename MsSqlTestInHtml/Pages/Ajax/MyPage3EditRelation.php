<?
        ...
        $_POST["person1"] != $_POST["person2"])
    {
        ...
        if (isset($_POST["id"]) && is_numeric($_POST["id"]) && $_POST["id"] > 0)
        {
            ...
            $query = odbc_exec($connection, "UPDATE [MsSqlTestDatabase].[dbo].[Relations] SET Person1 = '$person1Value', Relationship = '$relationshipValue', Person2 = '$person2Value' WHERE Id = '$idValue'");
        }
    }
?>