...
uses
  ...
  Dialogs, StdCtrls, Grids, Contnrs, Relationship;
...
begin
     ...
     begin
        ...
        sqlQuery.Close();
        sqlQuery.SQL.Text := 'SELECT * FROM [MsSqlTestDatabase].[dbo].[Relationships] WHERE IsDeleted = 0';
        ...
        begin
           ...
           begin
                ...
                begin
                     ...
                     sqlQuery.Close();
                     sqlQuery.SQL.Text := 'INSERT INTO [MsSqlTestDatabase].[dbo].[Relationships] (Id, Name, IsDeleted) VALUES (:param1, :param2, :param3)';
                ...
                begin
                     ...
                     sqlQuery.Close();
                     sqlQuery.SQL.Text := 'UPDATE [MsSqlTestDatabase].[dbo].[Relationships] SET IsDeleted = :param2 WHERE Id = :param1';
     ...
     begin
        ...
        begin
           ...
           begin
             ...
             sqlQuery.Close();
             sqlQuery.SQL.Text := 'UPDATE [MsSqlTestDatabase].[dbo].[Relationships] SET Name = :param2 WHERE Id = :param1';
