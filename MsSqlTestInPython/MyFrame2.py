        ...
        try:
            ...
            if (self.__nameValue <> None and self.__mothernameValue <> None and self.__locationValue <> None and self.__birthdateValue <> None and
                ...
                if (__matchFound == False):
                    ...
                    __cursor.execute('INSERT INTO [MsSqlTestDatabase].[dbo].[People] (Id, Name, Mothername, Location, Birthdate, IsDeleted) VALUES (%s, %s, %s, %s, %s, %s)',
                    ...
                    __cursor.execute('UPDATE [MsSqlTestDatabase].[dbo].[People] SET IsDeleted = %s WHERE Id = %s',
        ...
        try:
            ...
            if (self.__nameValue <> None and self.__mothernameValue <> None and self.__locationValue <> None and self.__birthdateValue <> None and
                ...
                if (self.__selectedIndexValue >= 0):
                    ...
                    # Execute.
                    __cursor.execute('UPDATE [MsSqlTestDatabase].[dbo].[People] SET Name = %s, Mothername = %s, Location = %s, Birthdate = %s WHERE Id = %s',
