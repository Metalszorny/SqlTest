	...
	public ref class Form2 : public System::Windows::Forms::Form
	{
			...
			try
            {
				...
				if (!String::IsNullOrEmpty(name) && !String::IsNullOrEmpty(mothername) && !String::IsNullOrEmpty(location) && !String::IsNullOrEmpty(birthdate))
                {
                    ...
                    if (matchFound->ToString()->ToLower() == "false")
                    {
                        ...
                        SqlCommand^ msSqlCommand = gcnew SqlCommand("INSERT INTO [MsSqlTestDatabase].[dbo].[People] (Id, Name, Mothername, Location, Birthdate, IsDeleted) VALUES (@param1, @param2, @param3, @param4, @param5, @param6)", msSqlConnection);
					...
					else
                    {
                        ...
                        SqlCommand^ msSqlCommand = gcnew SqlCommand("UPDATE [MsSqlTestDatabase].[dbo].[People] SET IsDeleted = @param2 WHERE Id = @param1", msSqlConnection);
			...
			try
            {
                ...
                if (!String::IsNullOrEmpty(name) && !String::IsNullOrEmpty(mothername) && !String::IsNullOrEmpty(location) && !String::IsNullOrEmpty(birthdate))
                {
                    ...
                    if (dataGridView1->CurrentCellAddress.X >= 0)
                    {
                        ...
                        SqlCommand^ msSqlCommand = gcnew SqlCommand("UPDATE [MsSqlTestDatabase].[dbo].[People] SET Name = @param2, Mothername = @param3, Location = @param4, BirthDate = @param5 WHERE Id = @param1", msSqlConnection);
		...
		private: System::Void GetData()
		{
			try
			{
                ...
                SqlCommand^ msSqlCommand = gcnew SqlCommand("SELECT * FROM [MsSqlTestDatabase].[dbo].[People] WHERE IsDeleted = 0", msSqlConnection);
                ...
                {
					people->Add(gcnew Person(msSqlDataReader->GetInt32(0), msSqlDataReader->GetString(1), msSqlDataReader->GetString(2), msSqlDataReader->GetString(3),
