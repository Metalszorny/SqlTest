    ...
    public partial class Form4 : Form
    {
        ...
        private void GetData()
        {
            try
            {
                ...
                {
                    people.Add(new Person(msSqlDataReader1.GetInt32(0), msSqlDataReader1.GetString(1), msSqlDataReader1.GetString(2),
                ...
                SqlCommand msSqlCommand2 = new SqlCommand("SELECT * FROM [MsSqlTestDatabase].[dbo].[Relationships]", msSqlConnection);
                ...
                SqlCommand msSqlCommand = new SqlCommand("SELECT * FROM [MsSqlTestDatabase].[dbo].[Relations] WHERE IsDeleted = 0", msSqlConnection);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (name1 != 0 && name2 != 0 && relationship != 0 && name1 != name2)
                {
                    ...
                    SqlCommand msSqlCommand1 = new SqlCommand("SELECT * FROM [MsSqlTestDatabase].[dbo].[Relations]", msSqlConnection);
                    ...
                    if (!matchFound)
                    {
                        ...
                        SqlCommand msSqlCommand = new SqlCommand("INSERT INTO [MsSqlTestDatabase].[dbo].[Relations] (Id, Person1, Relationship, Person2, IsDeleted) VALUES (@param1, @param2, @param3, @param4, @param5)", msSqlConnection);
                    ...
                    else
                    {
                        ...
                        SqlCommand msSqlCommand = new SqlCommand("UPDATE [MsSqlTestDatabase].[dbo].[Relations] SET IsDeleted = @param2 WHERE Id = @param1", msSqlConnection);
            ...
            try
            {
                ...
                if (name1 != 0 && name2 != 0 && relationship != 0 && name1 != name2)
                {
                    ...
                    if (dataGridView1.CurrentCellAddress.X >= 0)
                    {
                        ...
                        SqlCommand msSqlCommand = new SqlCommand("UPDATE [MsSqlTestDatabase].[dbo].[Relations] SET Person1 = @param2, Relationship = @param3, Person2 = @param4 WHERE Id = @param1", msSqlConnection);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridView1.CurrentCellAddress.X >= 0)
            {
                try
                {
                    ...
                    SqlCommand msSqlCommand = new SqlCommand("SELECT * FROM [MsSqlTestDatabase].[dbo].[Relations] WHERE Id = @param1", msSqlConnection);
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand msSqlCommand = new SqlCommand("SELECT * FROM [MsSqlTestDatabase].[dbo].[People] WHERE Id = @param1", msSqlConnection);
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand msSqlCommand = new SqlCommand("SELECT * FROM [MsSqlTestDatabase].[dbo].[Relationships] WHERE Id = @param1", msSqlConnection);
        ...
        private void comboBox3_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                while (msSqlDataReader.Read())
                {
                    retVal = new Person(msSqlDataReader.GetInt32(0), msSqlDataReader.GetString(1), msSqlDataReader.GetString(2), msSqlDataReader.GetString(3), msSqlDataReader.GetDateTime(4), msSqlDataReader.GetBoolean(5));
                }
