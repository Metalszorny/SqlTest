...
<?php
                                           // Get the items from the People table.
                                            $query = mysql_query("SELECT * FROM MySqlTestDatabase.People WHERE IsDeleted = 0");
...
?>
                                                <tr>
                                                    ...
                                                    <td class="TableBorder TableContent"><?php echo $people[$i * 6 + 4]; ?></td>
                                                </tr>
<?php
                                            }
?>
