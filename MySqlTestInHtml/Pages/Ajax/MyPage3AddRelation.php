<?
        ...
        $_POST["person1"] != $_POST["person2"])
    {
        ...
        $query = mysql_query("SELECT * FROM MySqlTestDatabase.Relations");
        ...
        if ($matchFound == false)
        {
            ...
            $query = mysql_query("INSERT INTO MySqlTestDatabase.Relations (Id, Person1, Relationship, Person2, IsDeleted) VALUES ('$idValue', '$person1Value', '$relationshipValue', '$person2Value', '$isDeletedValue')");
        }
        else
        {
