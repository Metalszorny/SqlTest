...
uses
  ...
  Graphics, Dialogs, StdCtrls, Grids, Person;
...
begin
     ...
     begin
          ...
          sqlQuery.Close();
          sqlQuery.SQL.Text := 'SELECT * FROM MySqlTestDatabase.People WHERE IsDeleted = 0';
     ...
     begin
        ...
        begin
           ...
           begin
              ...
              sqlQuery.Close();
              sqlQuery.SQL.Text := 'INSERT INTO MySqlTestDatabase.People (Id, Name, Mothername, Location, Birthdate, IsDeleted) VALUES (:param1, :param2, :param3, :param4, :param5, :param6)';
           ...
           begin
              ...
              sqlQuery.Close();
              sqlQuery.SQL.Text := 'UPDATE MySqlTestDatabase.People SET IsDeleted = :param2 WHERE Id = :param1';
     ...
     begin
        ...
        begin
           ...
           begin
             ...
             sqlQuery.Close();
             sqlQuery.SQL.Text := 'UPDATE MySqlTestDatabase.People SET Name = :param2, Mothername = :param3, Location = :param4, BirthDate = :param5 WHERE Id = :param1';
