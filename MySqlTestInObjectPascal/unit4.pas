...
uses
  ...
  Graphics, Dialogs, StdCtrls, Grids, Person, Relationship, Relation;
...
begin
     ...
     begin
        ...
        sqlQuery.Close();
        sqlQuery.SQL.Text := 'SELECT * FROM MySqlTestDatabase.People';
        ...
        { Get the items from the People table. }
        sqlQuery.Close();
        sqlQuery.SQL.Text := 'SELECT * FROM MySqlTestDatabase.Relations WHERE IsDeleted = 0';
...
begin
     ...
     begin
        ...
        begin
           ...
           sqlQuery.Close();
           sqlQuery.SQL.Text := 'SELECT * FROM MySqlTestDatabase.Relations';
           ...
           begin
              ...
              sqlQuery.Close();
              sqlQuery.SQL.Text := 'INSERT INTO MySqlTestDatabase.Relations (Id, Person1, Relationship, Person2, IsDeleted) VALUES (:param1, :param2, :param3, :param4, :param5)';
           ...
           begin
              ...
              sqlQuery.Close();
              sqlQuery.SQL.Text := 'UPDATE MySqlTestDatabase.Relations SET IsDeleted = :param2 WHERE Id = :param1';
     ...
     begin
        ...
        begin
           ...
           begin
             ...
             sqlQuery.Close();
             sqlQuery.SQL.Text := 'UPDATE MySqlTestDatabase.Relations SET Person1 = :param2, Relationship = :param3, Person2 = :param4 WHERE Id = :param1';
...
begin
     try
        begin
             ...
             { Get the items from the People table. }
             sqlQuery.Close();
             sqlQuery.SQL.Text := 'SELECT * FROM MySqlTestDatabase.People WHERE Id = :param1';
...
begin
     try
        begin
             ...
             { Get the items from the People table. }
             sqlQuery.Close();
             sqlQuery.SQL.Text := 'SELECT * FROM MySqlTestDatabase.Relationships WHERE Id = :param1';
...
begin
     ...
     begin
        ...
        begin
             ...
             { Get the items from the People table. }
             sqlQuery.Close();
             sqlQuery.SQL.Text := 'SELECT * FROM MySqlTestDatabase.Relations WHERE Id = :param1';
