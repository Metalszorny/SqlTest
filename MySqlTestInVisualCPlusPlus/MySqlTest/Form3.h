	...
	public ref class Form3 : public System::Windows::Forms::Form
	{
		...
		private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e)
		{
            ...
            try
            {
                ...
                if (!String::IsNullOrEmpty(name))
                {
                    ...
                    MySqlCommand^ mySqlCommand1 = gcnew MySqlCommand("SELECT * FROM MySqlTestDatabase.Relationships", mySqlConnection);
                    ...
                    if (matchFound->ToString()->ToLower() == "false")
                    {
                        ...
                        if (deletedFound->ToString()->ToLower() == "false")
                        {
                            ...
                            MySqlCommand^ mySqlCommand = gcnew MySqlCommand("INSERT INTO MySqlTestDatabase.Relationships (Id, Name, IsDeleted) VALUES (@param1, @param2, @param3)", mySqlConnection);
                        ...
                        else
                        {
                            ...
                            MySqlCommand^ mySqlCommand = gcnew MySqlCommand("UPDATE MySqlTestDatabase.Relationships SET IsDeleted = @param2 WHERE Id = @param1", mySqlConnection);
			...
			try
            {
                ...
                if (!String::IsNullOrEmpty(name))
                {
                    ...
                    if (dataGridView1->CurrentCellAddress.X >= 0)
                    {
                        ...
                        MySqlCommand^ mySqlCommand = gcnew MySqlCommand("UPDATE MySqlTestDatabase.Relationships SET Name = @param2 WHERE Id = @param1", mySqlConnection);
		...
		private: System::Void GetData()
		{
			try
            {
                ...
                MySqlCommand^ mySqlCommand = gcnew MySqlCommand("SELECT * FROM MySqlTestDatabase.Relationships WHERE IsDeleted = 0", mySqlConnection);
                ...
                {
                    relationships->Add(gcnew Relationship(mySqlDataReader->GetInt32("Id"), mySqlDataReader->GetString("Name"), mySqlDataReader->GetBoolean("IsDeleted")));
                }
