...
<html>
	<head>
		<title>OracleSqlTest - People</title>
...
<?php
                                           // Get the items from the People table.
                                            $query = oci_parse($connection, "SELECT * FROM root.People WHERE IsDeleted = 0");
...
?>
                                                <tr>
                                                    <td class="TableBorder TableContent"><?php echo $people[$i + 0 * (count($people) / 6)]; ?></td>
                                                    <td class="TableBorder TableContent"><?php echo $people[$i + 1 * (count($people) / 6)]; ?></td>
                                                    <td class="TableBorder TableContent"><?php echo $people[$i + 2 * (count($people) / 6)]; ?></td>
                                                    <td class="TableBorder TableContent"><?php echo $people[$i + 3 * (count($people) / 6)]; ?></td>
                                                    <td class="TableBorder TableContent"><?php echo $people[$i + 4 * (count($people) / 6)]; ?></td>
                                                </tr>
<?php
                                            }
?>
...
<?php
																...
																{
?>
																    <option><?php echo $people[$i + 0 * (count($people) / 6)]; ?></option>
<?php
																}
?>
															</select>
