...
<html>
	<head>
		<title>OracleSqlTest - Relationships</title>
...
<?php
    										...
    										$query = oci_parse($connection, "SELECT * FROM root.Relationships WHERE IsDeleted = '0'");
...
?>
    								            <tr>
    								            	<td class="TableBorder TableContent"><?php echo $relationships[$i + 0 * (count($relationships) / 3)]; ?></td>
                                                    <td class="TableBorder TableContent"><?php echo $relationships[$i + 1 * (count($relationships) / 3)]; ?></td>
    								            </tr>
<?php
    								        }
?>
...
<?php
                                                                ...
                                                                {
?>
                                                                   <option><?php echo $relationships[$i + 0 * (count($relationships) / 3)]; ?></option>
<?php
                                                                }
?>
															</select>
