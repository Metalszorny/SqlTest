...
<html>
	<head>
		<title>OracleSqlTest - Relations</title>
...
<?php
    										...
    										$query = oci_parse($connection, "SELECT * FROM root.Relations WHERE IsDeleted = '0'");
...
?>
    								            <tr>
    								            	<td class="TableBorder TableContent"><?php echo $relations[$i + 0 * (count($relations) / 5)]; ?></td>
<?php
                                                    ...
                                                    for ($j = 0; $j < count($people) / 6; $j++)
                                                    {
                                                        ...
                                                        {
?>
    													   <td class="TableBorder TableContent"><?php echo $people[$j + 1 * (count($people) / 6)]; ?></td>
<?php
                                                        }
                                                    }
                                                    ...
                                                    for ($j = 0; $j < count($relationships) / 3; $j++)
                                                    {
                                                        ...
                                                        {
?>
    													   <td class="TableBorder TableContent"><?php echo $relationships[$j + 1 * (count($relationships) / 3)]; ?></td>
<?php
                                                        }
                                                    }
...
<?php
                                                                ...
                                                                {
?>
                                                                   <option><?php echo $relations[$i + 0 * (count($relations) / 5)]; ?></option>
<?php
                                                                }
?>
															</select>
...
<?php
                                                                ...
                                                                {
                                                                    if ($people[$j + 5 * (count($people) / 6)] == false)
                                                                    {
?>
                                                                        <option><?php echo $people[$j + 0 * (count($people) / 6)]; ?></option>
<?php
                                                                    }
                                                                }
?>
...
<?php
                                                                ...
                                                                {
                                                                    if ($relationships[$j + 2 * (count($relationships) / 3)] == false)
                                                                    {
?>
                                                                        <option><?php echo $relationships[$j + 0 * (count($relationships) / 3)]; ?></option>
<?php
                                                                    }
                                                                }
?>
