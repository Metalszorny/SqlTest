<?
        ...
        $_POST["location"] != "" && $_POST["birthdate"] != "")
    {
        ...
        if (isset($_POST["id"]) && is_numeric($_POST["id"]) && $_POST["id"] > 0)
        {
            ...
            $query = oci_parse($connection, "UPDATE root.People SET Name = '$nameValue', Mothername = '$mothernameValue', Location = '$locationValue', Birthdate = '$birthdateValue' WHERE Id = '$idValue'");
