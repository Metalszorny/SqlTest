...
uses
  ...
  Controls, Graphics, Dialogs, StdCtrls, Grids, Contnrs, Relationship;
...
begin
     ...
     begin
        ...
        sqlQuery.Close();
        sqlQuery.SQL.Text := 'SELECT * FROM root.Relationships WHERE IsDeleted = 0';
        ...
        begin
           ...
           begin
               ...
               if ((matchFound = False) And
                  ...
                  (sqlQuery.FieldByName('IsDeleted').AsInteger = 0)) then
               begin
                  matchFound := True;
           ...
           begin
                ...
                begin
                     ...
                     sqlQuery.Close();
                     sqlQuery.SQL.Text := 'INSERT INTO root.Relationships (Id, Name, IsDeleted) VALUES (:param1, :param2, :param3)';
                     ...
                     sqlQuery.Params.ParamByName('param3').AsInteger := 0;
                ...
                begin
                     ...
                     sqlQuery.Close();
                     sqlQuery.SQL.Text := 'UPDATE root.Relationships SET IsDeleted = :param2 WHERE Id = :param1';
     ...
     begin
        ...
        begin
           ...
           begin
             ...
             sqlQuery.Close();
             sqlQuery.SQL.Text := 'UPDATE root.Relationships SET Name = :param2 WHERE Id = :param1';
