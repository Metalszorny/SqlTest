...
uses
  Classes, SysUtils, mssqlconn, sqldb, oracleconnection, FileUtil, Forms,
  Controls, Graphics, Dialogs, StdCtrls, Grids, Contnrs, Person, Relationship, Relation;
...
var
  ...
  sqlConnection: TOracleConnection;
  sqlQuery: TSQLQuery;
...
function IntToBool(input: Integer): Boolean;
begin
     if (input > 0) then
     begin
        IntToBool := True;
...
begin
     ...
     begin
        ...
        sqlConnection := TOracleConnection.Create(nil);
        ...
        sqlConnection.DatabaseName := 'orcl';
        ...
        sqlQuery.Close();
        sqlQuery.SQL.Text := 'SELECT * FROM root.People';
        ...
        begin
             personList.Add(TPerson.Create(
              ...
              IntToBool(sqlQuery.FieldByName('IsDeleted').AsInteger)));
        ...
        { Get the items from the People table. }
        sqlQuery.Close();
        sqlQuery.SQL.Text := 'SELECT * FROM root.Relationships';
        ...
        { Get the items from the People table. }
        sqlQuery.Close();
        sqlQuery.SQL.Text := 'SELECT * FROM root.Relations WHERE IsDeleted = 0';
...
begin
     ...
     begin
        ...
        begin
           ...
           sqlQuery.Close();
           sqlQuery.SQL.Text := 'SELECT * FROM root.Relations';
           ...
           begin
               ...
               if ((matchFound = False) And
                  ...
                  (sqlQuery.FieldByName('IsDeleted').AsInteger = 1)) then
               begin
                  matchFound := True;
           ...
           begin
              ...
              sqlQuery.Close();
              sqlQuery.SQL.Text := 'INSERT INTO root.Relations (Id, Person1, Relationship, Person2, IsDeleted) VALUES (:param1, :param2, :param3, :param4, :param5)';
              ...
              sqlQuery.Params.ParamByName('param5').AsInteger := 0;
           ...
           begin
              ...
              sqlQuery.Close();
              sqlQuery.SQL.Text := 'UPDATE root.Relations SET IsDeleted = :param2 WHERE Id = :param1';

              { Fill the values of the command. }
              sqlQuery.Params.ParamByName('param1').AsInteger := idValue;
              sqlQuery.Params.ParamByName('param2').AsInteger := 0;
     ...
     begin
        ...
        begin
           ...
           begin
             ...
             sqlQuery.Close();
             sqlQuery.SQL.Text := 'UPDATE root.Relations SET Person1 = :param2, Relationship = :param3, Person2 = :param4 WHERE Id = :param1';
...
begin
     ...
     begin
          ...
          begin
             ...
             { Fill the values of the command. }
             sqlQuery.Params.ParamByName('param1').AsInteger := idValue;
             sqlQuery.Params.ParamByName('param2').AsInteger := 1;
...
begin
     try
        begin
             ...
             { Get the items from the People table. }
             sqlQuery.Close();
             sqlQuery.SQL.Text := 'SELECT * FROM root.People WHERE Id = :param1';
...
begin
     try
        begin
             ...
             { Get the items from the People table. }
             sqlQuery.Close();
             sqlQuery.SQL.Text := 'SELECT * FROM root.Relationships WHERE Id = :param1';
...
begin
     ...
     begin
        ...
        begin
             ...
             { Get the items from the People table. }
             sqlQuery.Close();
             sqlQuery.SQL.Text := 'SELECT * FROM root.Relations WHERE Id = :param1';
