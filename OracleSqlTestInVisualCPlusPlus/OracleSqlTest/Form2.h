	...
	public ref class Form2 : public System::Windows::Forms::Form
	{
			...
			try
            {
				...
				if (!String::IsNullOrEmpty(name) && !String::IsNullOrEmpty(mothername) && !String::IsNullOrEmpty(location) && !String::IsNullOrEmpty(birthdate))
                {
                    ...
                    if (matchFound->ToString()->ToLower() == "false")
                    {
                        ...
                        OracleCommand^ oracleSqlCommand = gcnew OracleCommand("INSERT INTO root.People (Id, Name, Mothername, Location, Birthdate, IsDeleted) VALUES (:param1, :param2, :param3, :param4, :param5, :param6)", oracleSqlConnection);
					...
					else
                    {
                        ...
                        OracleCommand^ oracleSqlCommand = gcnew OracleCommand("UPDATE root.People SET IsDeleted = :param2 WHERE Id = :param1", oracleSqlConnection);
			...
			try
            {
                ...
                if (!String::IsNullOrEmpty(name) && !String::IsNullOrEmpty(mothername) && !String::IsNullOrEmpty(location) && !String::IsNullOrEmpty(birthdate))
                {
                    ...
                    if (dataGridView1->CurrentCellAddress.X >= 0)
                    {
                        ...
                        OracleCommand^ oracleSqlCommand = gcnew OracleCommand("UPDATE OracleSqlTestDatabase.People SET Name = :param2, Mothername = :param3, Location = :param4, BirthDate = :param5 WHERE Id = :param1", oracleSqlConnection);
		...
		private: System::Void button4_Click(System::Object^  sender, System::EventArgs^  e)
		{
			...
			try
            {
                ...
                if (dataGridView1->CurrentCellAddress.X >= 0)
                {
                    ...
                    OracleCommand^ oracleSqlCommand = gcnew OracleCommand("UPDATE OracleSqlTestDatabase.People SET IsDeleted = :param2 WHERE Id = :param1", oracleSqlConnection);
		...
		private: System::Void GetData()
		{
			try
			{
                ...
                OracleCommand^ oracleSqlCommand = gcnew OracleCommand("SELECT * FROM root.People WHERE IsDeleted = 0", oracleSqlConnection);
                ...
                {
					people->Add(gcnew Person(oracleSqlDataReader->GetInt32(0), oracleSqlDataReader->GetString(1), oracleSqlDataReader->GetString(2), oracleSqlDataReader->GetString(3),
