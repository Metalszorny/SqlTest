	...
	public ref class Form3 : public System::Windows::Forms::Form
	{
		...
		private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e)
		{
            ...
            try
            {
                ...
                if (!String::IsNullOrEmpty(name))
                {
                    ...
                    OracleCommand^ oracleSqlCommand1 = gcnew OracleCommand("SELECT * FROM root.Relationships", oracleSqlConnection);
                    ...
                    if (matchFound->ToString()->ToLower() == "false")
                    {
                        ...
                        if (deletedFound->ToString()->ToLower() == "false")
                        {
                            ...
                            OracleCommand^ oracleSqlCommand = gcnew OracleCommand("INSERT INTO root.Relationships (Id, Name, IsDeleted) VALUES (:param1, :param2, :param3)", oracleSqlConnection);
                        ...
                        else
                        {
                            ...
                            OracleCommand^ oracleSqlCommand = gcnew OracleCommand("UPDATE root.Relationships SET IsDeleted = :param2 WHERE Id = :param1", oracleSqlConnection);
			...
			try
            {
                ...
                if (!String::IsNullOrEmpty(name))
                {
                    ...
                    if (dataGridView1->CurrentCellAddress.X >= 0)
                    {
                        ...
                        OracleCommand^ oracleSqlCommand = gcnew OracleCommand("UPDATE root.Relationships SET Name = :param2 WHERE Id = :param1", oracleSqlConnection);
		...
		private: System::Void GetData()
		{
			try
            {
                ...
                OracleCommand^ oracleSqlCommand = gcnew OracleCommand("SELECT * FROM root.Relationships WHERE IsDeleted = 0", oracleSqlConnection);
                ...
                {
                    relationships->Add(gcnew Relationship(oracleSqlDataReader->GetInt32(0), oracleSqlDataReader->GetString(1), oracleSqlDataReader->GetInt32(2) == 1 ? true : false));
                }
