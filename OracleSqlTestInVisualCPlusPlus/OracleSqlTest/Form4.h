	...
	public ref class Form4 : public System::Windows::Forms::Form
	{
		...
		private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e)
		{
			...
			try
            {
                ...
                if (name1 != 0 && name2 != 0 && relationship != 0 && name1 != name2)
                {
                    ...
                    OracleConnection^ oracleSqlConnection = gcnew OracleConnection(url);
                    oracleSqlConnection->Open();

                    // Get the items of the Relations table.
                    OracleCommand^ oracleSqlCommand1 = gcnew OracleCommand("SELECT * FROM root.Relations", oracleSqlConnection);
                    ...
                    if (matchFound->ToString()->ToLower() == "false")
                    {
                        ...
                        OracleCommand^ oracleSqlCommand = gcnew OracleCommand("INSERT INTO root.Relations (Id, Person1, Relationship, Person2, IsDeleted) VALUES (:param1, :param2, :param3, :param4, :param5)", oracleSqlConnection);
                    ...
                    else
                    {
                        ...
                        OracleCommand^ oracleSqlCommand = gcnew OracleCommand("UPDATE root.Relations SET IsDeleted = :param2 WHERE Id = :param1", oracleSqlConnection);
			...
			try
            {
                ...
                if (name1 != 0 && name2 != 0 && relationship != 0 && name1 != name2)
                {
                    ...
                    if (dataGridView1->CurrentCellAddress.X >= 0)
                    {
                        ...
                        OracleCommand^ oracleSqlCommand = gcnew OracleCommand("UPDATE root.Relations SET Person1 = :param2, Relationship = :param3, Person2 = :param4 WHERE Id = :param1", oracleSqlConnection);
		...
		private: System::Void comboBox1_SelectedIndexChanged(System::Object^  sender, System::EventArgs^  e)
		{
			...
			try
            {
                ...
                OracleCommand^ oracleSqlCommand = gcnew OracleCommand("SELECT * FROM root.People WHERE Id = :param1", oracleSqlConnection);
                ...
                {
                    retVal = gcnew Person(oracleSqlDataReader->GetInt32(0), oracleSqlDataReader->GetString(1), oracleSqlDataReader->GetString(2),
		...
		private: System::Void comboBox2_SelectedIndexChanged(System::Object^  sender, System::EventArgs^  e)
		{
			...
			try
            {
                ...
                OracleCommand^ oracleSqlCommand = gcnew OracleCommand("SELECT * FROM root.Relationships WHERE Id = :param1", oracleSqlConnection);
                ...
                while (oracleSqlDataReader->Read())
                {
                    retVal = gcnew Relationship(oracleSqlDataReader->GetInt32(0), oracleSqlDataReader->GetString(1), oracleSqlDataReader->GetInt32(2) == 1 ? true : false);
                }
		...
		private: System::Void comboBox3_SelectedIndexChanged(System::Object^  sender, System::EventArgs^  e)
		{
			...
			try
            {
                ...
                while (oracleSqlDataReader->Read())
                {
                    retVal = gcnew Person(oracleSqlDataReader->GetInt32(0), oracleSqlDataReader->GetString(1), oracleSqlDataReader->GetString(2), oracleSqlDataReader->GetString(3), 
		...
		private: System::Void Form4_Load(System::Object^  sender, System::EventArgs^  e)
		{
			...
			label8->Text = "";
			label9->Text = "";
			url = "Data Source=(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)" + 
		...
		private: System::Void dataGridView1_CellClick(System::Object^  sender, System::Windows::Forms::DataGridViewCellEventArgs^  e)
		{
			...
			if (dataGridView1->CurrentCellAddress.X >= 0)
            {
                try
                {
                    ...
                    OracleCommand^ oracleSqlCommand = gcnew OracleCommand("SELECT * FROM root.Relations WHERE Id = :param1", oracleSqlConnection);
                    ...
                    while (oracleSqlDataReader->Read())
                    {
                        relation = gcnew Relation(oracleSqlDataReader->GetInt32(0), oracleSqlDataReader->GetInt32(1), oracleSqlDataReader->GetInt32(2),
		...
		private: System::Void GetData()
		{
			try
            {
                ...
                OracleCommand^ oracleSqlCommand1 = gcnew OracleCommand("SELECT * FROM root.People", oracleSqlConnection);
                ...
                while (oracleSqlDataReader1->Read())
                {
                    people->Add(gcnew Person(oracleSqlDataReader1->GetInt32(0), oracleSqlDataReader1->GetString(1), oracleSqlDataReader1->GetString(2),
                ...
                OracleCommand^ oracleSqlCommand2 = gcnew OracleCommand("SELECT * FROM root.Relationships", oracleSqlConnection);
                ...
                {
                    relationships->Add(gcnew Relationship(oracleSqlDataReader2->GetInt32(0), oracleSqlDataReader2->GetString(1), oracleSqlDataReader2->GetInt32(2) == 1 ? true : false));
                }
                ...
                OracleCommand^ oracleSqlCommand = gcnew OracleCommand("SELECT * FROM root.Relations WHERE IsDeleted = 0", oracleSqlConnection);
                ...
                while (oracleSqlDataReader->Read())
                {
                    relations->Add(gcnew Relation(oracleSqlDataReader->GetInt32(0), oracleSqlDataReader->GetInt32(1), oracleSqlDataReader->GetInt32(2),
                        oracleSqlDataReader->GetInt32(3), oracleSqlDataReader->GetInt32(4) == 1 ? true : false));
                }
